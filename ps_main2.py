...
class PokemonBot():
	...
	def getUtility(self, currentEnemies):
		sum = 0
	...
	def start(self):
		...
		button.click()
		time.sleep(2)
		self.browser.find_element_by_name('username').send_keys('suygnu')
		time.sleep(1)
		self.browser.find_element_by_xpath("/html/body/div[4]/div/form/p[2]/button[1]").click()
		time.sleep(3)
		self.browser.find_element_by_name('password').send_keys('Yl22ujO7EIL8')
		time.sleep(1)
		self.browser.find_element_by_xpath('/html/body/div[4]/div/form/p[5]/button[1]').click()
		time.sleep(1)
		self.browser.find_element_by_css_selector('.button.mainmenu5.onlineonly').click()
		self.browser.find_element_by_name('data').send_keys('suygnu1')
		self.browser.find_element_by_xpath('/html/body/div[4]/form/p[2]/button[1]').click()
		time.sleep(2)
		self.browser.find_element_by_name('challenge').click()
		time.sleep(1)
		self.browser.find_element_by_name('makeChallenge')

		# file = open("all_pokes.txt", "r")
		# for line in file:
		...
		# print('utility')
		# print(str(self.getUtility(userPokemon)))
		# previous = 0
